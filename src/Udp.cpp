...
//        switch (err)
//        {
//            case WSASYSNOTREADY: std::cout << "WSASYSNOTREADY" << std::endl; break;
//            case WSAVERNOTSUPPORTED: std::cout << "WSAVERNOTSUPPORTED" << std::endl; break;
//            case WSAEINPROGRESS: std::cout << "WSAEINPROGRESS" << std::endl; break;
//            case WSAEPROCLIM: std::cout << "WSAEPROCLIM" << std::endl; break;
